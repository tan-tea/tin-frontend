...
const bottomNavigation = tv({
    slots: {
        ...
        container: 'w-full h-auto px-2 py-4 flex items-center justify-between rounded-t-2xl border border-[var(--mui-palette-grey-100)] shadow-xs dark:bg-dark-400 dark:border-none',
